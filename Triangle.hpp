...
{
public:
    MeshTriangle(const std::string& filename, Material *mt = new Material(), Vector3f trans = Vector3f(0.f, 0.f, 0.f), Vector3f scale = Vector3f(1.f, 1.f, 1.f),
