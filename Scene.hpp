...
public:
    ...
    Vector3f mis_directLight(Intersection intersection, Vector3f wo, Intersection L_dir_Inter, float pdf_light, int depth) const;//wmz
    void sampleLight(Intersection &pos, float &pdf) const;
    void sampleLightSphere(Intersection& pos, float& pdf) const;
